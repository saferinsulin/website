...
// Copy third party libraries from node_modules into /vend   "cp": "cp ./dist/js/insulin-calc.js ./app/www/js/insulin-calc.js",or
...
gulp.task('replaceHtmlBlock', function () {
  return gulp.src(['index.html', 'governance.html', 'resources.html', 'old.html'])
    .pipe(htmlreplace({
